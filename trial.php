            ...
            try {
                ...
                <div class="admin-panel" id="student-table">
                    ...
                    <table>
                        ...
                        <td class="col" style="background-color:#f3c06f; border: 2px solid black;"><button type="submit" class="btn btn-primary" style="background-color:red; color:white" name="delete" value=' . $row[5] . '>Delete</button></td>
                    </tr>');
                                }
                            }
                            $check->close();
            ...
            <div class="admin-panel" id="faculty-table">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <td class="col" style="background-color:#ffff99; border: 2px solid black;">' . $row[3] . '</td>
                        <td class="col" style="background-color:#ffff99; border: 2px solid black;">' . $row[6] . '</td>
                        <td class="col" style="background-color:#f3c06f; border: 2px solid black;"><button type="submit" class="btn btn-primary" style="background-color:red; color:white" name="deleteFac" value=' . $row[5] . '>Delete</button></td>
                    </tr>');
                            }
                        }
                        $check->close();
            ...
            <div class="admin-panel" id="bus-table">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <td class="col" style="background-color:#ffff99; border: 2px solid black;">' . $row[6] . '</td>
                        <td class="col" style="background-color:#f3c06f; border: 2px solid black;">' . $row[7] . '</td>
                    </tr>');
                            }
                        }
                        $check->close();
